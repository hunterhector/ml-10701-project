...
P98-2184
c©2006 Association for Computational Linguistics Parsing and Subcategorization Data Jianguo Li Department of Linguistics The Ohio State University Columbus, OH, USA jianguo@ling.ohio-state.edu Abstract In this paper, we compare the performance of a state-of-the-art statistical parser (Bikel, 2004) in parsing written and spoken language and in generating subcategorization cues from written and spoken language.
J04-4004
• Passive Structures: As noted above, Roland and Jurafsky (Roland and Jurafsky, 1998) have noticed that written language tends to have a much higher percentage of passive structures than spoken language.
P98-2184
...
P98-2184
Both Roark (2001) and Engel et al.(2002) report that removing punctuation from both training and test data (Switchboard) results in only 1% decrease in their parser’s accuracy.
W02-1007
As noted in Engel et al.(2002), statistical parsers usually condition the probability of a constituent on the types of its neighboring constituents.
W02-1007
